...
As front-end developer (mobile and Web), I'm used to consuming REST API. Smart libraries like Retrofit  (Android), Unirest (Java) and Axios (JavsScript) allow me to do it simple. All is neat, easy to set up and use. All me requirements as a developer are fullfilled.
